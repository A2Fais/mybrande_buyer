...
<div class="mobile-bg-settings-container">
  <div>
    <div id="color-mode" class="color-mode-selector" style="display: flex; flex-direction: row-reverse; justify-content: space-around; gap: 30px; align-items: flex-start;">
      <div id="gradient-panel-viewer" style="display: flex; flex-direction: column; align-items: center;">
        <div id="color-palette-gradient" class="color-palette-gradient" style="height: 30px; width: 200px; transform: rotate(180deg); background: linear-gradient(-90deg, #ffffff, #000000);"></div>
      ...
      <div id="gradient-panel" style="display: flex; justify-content: center; gap: 20px; width: 100%;">
        <div style="display: flex; flex-direction: column; align-items: center;">
          <input type="color" value="#ffffff" id="grad-1" style="width: 40px; height: 30px; border: none; border-radius: 5px; outline: none; padding: 1px; appearance: none; background: #fff">
          <div style="text-align: center; font-size: 12px; color: var(--gray-light);">Color 1</div>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center;">
          <input type="color" value="#000000" id="grad-2" style="width: 40px; height: 30px; border: none; border-radius: 5px; outline: none; padding: 1px; appearance: none; background: #fff">
